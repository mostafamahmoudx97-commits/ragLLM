...
from controllers import DataControllers,ProjectControllers,ProcessContreller
import aiofiles
...
async def process_endpoint(request:Request,project_id:int,process_request:ProcessRequest):
     ...
     process_controllers=ProcessContreller(project_id=project_id)
     ...
     if process_request.do_reset == 1:
          ...
          #delete associated chunks collection
     ...
     for asset_id , file_id in project_files_ids.items():
          file_content=process_controllers.get_file_content(file_id=file_id)
